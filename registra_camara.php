...
<form action="grabar_mantenimiento.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
  ...
  <tbody>
    <tr>
      <th class="texto_centro" scope="row">	CAMARA</th>
    </tr>
  </tbody>
</table>
<table width="600" border="1" cellspacing="5" cellpadding="5">
  <tbody>
    <tr>
      <th width="196" class="texto_formulario" scope="row">CODIGO CAMARA:</th>
      <td width="263"><input type="text" name="id3" id="id3" /></td>
    </tr>
    <tr>
      <th class="texto_formulario" scope="row">CODIGO SENSOR:</th>
      <td><input type="text" name="fech" id="fech" /></td>
    </tr>
    <tr>
      <th class="texto_formulario" scope="row">CODIGO MANTENIMIENTO</th>
      <td><input type="text" name="hr" id="hr" /></td>
    </tr>
     <tr>
      <th height="34" class="texto_formulario" scope="row">TIPO:</th>
      <td><input type="text" name="ob" id="ob" /></td>
    </tr>
     <tr>
      <th height="34" class="texto_formulario" scope="row">DIMENSION:</th>
      <td><input type="text" name="ob" id="ob" /></td>
    </tr>
     <tr>
      <th height="34" class="texto_formulario" scope="row">PROFUNDIDAD:</th>
      <td><input type="text" name="ob" id="ob" /></td>
       <tr>
      <th height="34" class="texto_formulario" scope="row">CANTIDAD TOTAL DE ALMACENAJE:</th>
      <td><input type="text" name="ob" id="ob" /></td>
    </tr>
    </tr>
  </tbody>
